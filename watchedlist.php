...
<body>
    ...
    <?php 
        $sql = "SELECT * FROM watched WHERE username='$username'";
        		...
        		<?php
        		  if($result) {
        		  	...
        		  	while($row = $result->fetch_assoc()) {?>
        		  		<tr>
        		  			<td><?php echo $i;?></td>
        		  			<td><a href="viewmovie.php?variable1=<?php echo $row['movie_name']; ?>"><?php echo $row['movie_name'];?></a></td>
        		  		</tr>
        		  		<?php $i++;
        		  	}?>
        		  <?php }?>
